...
figure(2)
waterfall(f_val,B_f_val(2:end),10*spectrum_m(2:end,:))
title('')
...
figure(3)
[M,c] = contourf(B_f_val(2:end),f_val,10*spectrum_m(2:end,:)',20);
...
figure(4)
[M,c] = contourf(B_f_val(2:end),f_val,10*spectrum_p(2:end,:)',20);
set(c,'LineColor','none')
caxis([-60 20]);
xlabel('B_{ext}, gauss','FontSize',18)
ylabel('\omega/\Omega_{out}','FontSize',18)
